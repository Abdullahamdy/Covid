<div wire:ignore class=""style="display:inline">
    @can('تعديل منتج')
       ...
       <button type="button" class="btn btn-secondary d-inline" data-bs-toggle="modal" data-target="#modal-secondary" data-bs-target=".editpatienbooking{{$pat_booking['id']}}">
        <i class="nav-icon fas fa-edit"></i>

      </button>
      @endcan
       <div  class="modal fade editpatienbooking{{$pat_booking['id']}}" id="modal-secondary">
